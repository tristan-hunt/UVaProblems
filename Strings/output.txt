...
/* Driver program to test search function*/
int test_1()
{
...
/* Driver program to test printArr, buildSuffixArray, cmp functions*/
int test_2()
{
    char txt[] = "banana";
    int n = strlen(txt);
...
/* Remember our goal: Find the longest repeated substring*/
int main(){
    return 0;
}
