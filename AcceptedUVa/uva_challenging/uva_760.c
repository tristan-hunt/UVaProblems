...
#  *   Given two strands of DNA (repr. as a string), find the 
#  *     longest common substring. 
#  *
#  * Solution Summary:
#  *    0. Concat strings, seperate with '#'
#  *    1. Create a suffix array
#  *    2. Create an LCP array
#  *    3. Find the max lcp length for a prefix that is a prefix on both sides of the #
#  *    4. Print out each lcp of length max_lcp, without duplicates
#  *   
#  * Used Resources:
