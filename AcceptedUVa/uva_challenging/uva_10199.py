...
#  *
#  * Find the cameras in the city, which are placed on the a
#  *  articulation points of the graph of the city, if we take
#  *  the vertices to be the neighbourhoods and the edges to be
#  *  the streets between them.  
#  *
#  * Solution Summary:
#  *	1. Implement an algorithm for finding articulation points in a graph
#  *   
#  * Used Resources:
