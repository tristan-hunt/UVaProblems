...
#  *	Find the maximal connected subgraphs of a graph
#  *   i.e. find each connected component
#  * Solution Summary:
#  *	Use DFS to find a connected component. While searching, 
#  *    keep track of the number of components found. 
#  *   
#  * Used Resources:
